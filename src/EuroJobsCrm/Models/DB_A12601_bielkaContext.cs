    ...
    public partial class DB_A12601_bielkaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clients>(entity =>
            {
                ...
                entity.Property(e => e.CltAuditCu).HasColumnName("clt_audit_cu");

                entity.Property(e => e.CltAuditMd)
                    .HasColumnName("clt_audit_md")
                    .HasColumnType("datetime");

                entity.Property(e => e.CltAuditMu).HasColumnName("clt_audit_mu");

                entity.Property(e => e.CltAuditRd)
                    .HasColumnName("clt_audit_rd")
                    .HasColumnType("datetime");

                entity.Property(e => e.CltAuditRu).HasColumnName("clt_audit_ru");
            ...
            modelBuilder.Entity<Contragents>(entity =>
            {
                ...
                entity.Property(e => e.CgtAuditCu).HasColumnName("cgt_audit_cu");
            ...
            modelBuilder.Entity<Employees>(entity =>
            {
                ...
                entity.Property(e => e.EmpAuditCu).HasColumnName("emp_audit_cu");

                entity.Property(e => e.EmpAuditMd)
                    .HasColumnName("emp_audit_md")
                    .HasColumnType("datetime");

                entity.Property(e => e.EmpAuditMu).HasColumnName("emp_audit_mu");

                entity.Property(e => e.EmpAuditRd)
                    .HasColumnName("emp_audit_rd")
                    .HasColumnType("datetime");

                entity.Property(e => e.EmpAuditRu).HasColumnName("emp_audit_ru");
        ...
        // Unable to generate entity type for table 'dbo.Addresses'. Please see the warning messages.
    }
}